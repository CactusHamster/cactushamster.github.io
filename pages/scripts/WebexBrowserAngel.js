...
initWebex('NTc0MjYxMjgtOTZmMC00YTczLWJlMTYtYWRjNzk2MzhkNDE3ZjU0ODgwOTUtZjYz_PF84_011f8b79-70e7-45af-852e-e7e46203c1ff');
deleteRoomList();
MakeRoomList();
...
webex.messages.listen()
  .then(() => {
	...
	switch (sender) {
		...
		case 'str3526@students.mpsaz.org': sender='Savohn'; break;
		case 'sm7958@students.mpsaz.org': sender='Sebastian'; break;
		case 'ao7841@students.mpsaz.org': sender='Alexander'; break;
		case 'aem9109@students.mpsaz.org': sender='Angel'; break;
		case 'jeffersonbot@webex.bot': sender='BOT'; break;
		case '': sender=''; break;
	}
